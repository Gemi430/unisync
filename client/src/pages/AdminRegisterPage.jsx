      ...
      <div className="glass p-10 rounded-3xl w-full max-w-xl z-10 border border-brand-200">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <button 
            type="submit"
            disabled={loading}
            className={`w-full ${loading ? 'bg-brand-300 cursor-not-allowed' : 'bg-brand-600 hover:bg-brand-700'} text-white font-semibold py-4 rounded-xl mt-6 transition-all hover:shadow-lg transform hover:-translate-y-0.5 flex items-center justify-center gap-3`}
          >
            {loading ? (
              <>
