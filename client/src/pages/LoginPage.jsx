    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="glass p-10 rounded-3xl w-full max-w-md z-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button 
            type="submit"
            className="w-full bg-brand-600 hover:bg-brand-700 text-white font-semibold py-4 rounded-xl transition-all hover:shadow-lg transform hover:-translate-y-0.5"
          >
            Log In
          </button>
        </form>
